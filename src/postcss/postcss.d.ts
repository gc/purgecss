...
declare namespace postcss {
  ...
  export type TransformCallback = (root: Root, result: Result) => Promise<void> | void
  ...
  export type Parser<RootNode = Document | Root> = (
      css: { toString(): string } | string,
      opts?: Pick<ProcessOptions, 'from' | 'map'>) => RootNode

  export type Builder = (part: string, node?: AnyNode, type?: 'end' | 'start') => void

  export type Stringifier = (node: AnyNode, builder: Builder) => void

...
var PreviousMap = class {
  ...
  consumer() {
    if (!this.consumerCache) {
      this.consumerCache = new import_source_map_js.SourceMapConsumer(this.text);
    }
  ...
  loadMap(file, prev) {
    ...
    if (prev) {
      ...
      } else if (prev instanceof import_source_map_js.SourceMapConsumer) {
        return import_source_map_js.SourceMapGenerator.fromSourceMap(prev).toString();
      } else if (prev instanceof import_source_map_js.SourceMapGenerator) {
